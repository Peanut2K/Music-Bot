module.exports = {
  ...
  Token: process.env.Token || "OTY3MDg5OTM1OTgxMDk3MDQx.YmLOsA.xDD_sJPBUxz3PoIzHBVdTcl1phc", //Discord Bot Token
  ClientID: process.env.Discord_ClientID || "967089935981097041", //Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "HvLwddxM-PBZtGWE8PUJ62cRV_QOEQuo", //Discord Client Secret
  Scopes: ["identify", "guilds", "applications.commands"], //Discord OAuth2 Scopes
  ServerDeafen: true, //If you want bot to stay deafened
  DefaultVolume: 100, //Sets the default volume of the bot, You can change this number anywhere from 1 to 100
  CallbackURL: "/api/callback", //Discord API Callback url. Do not touch it if you don't know what you are doing. All you need to change for website to work is on line 20.
  "24/7": false, //If you want the bot to be stay in the vc 24/7
  CookieSecret: "Mon so cute", //A Secret like a password
  IconURL:
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "7b5407a399b9409b997f7092db02baa5", //Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "d60fdf4fcc9f4d6a8d5ca0f498465b12", //Spotify Client Secret
  },
};
